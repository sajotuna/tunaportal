							...
							<div class="col-md-3 col-xl-2 fomrtag">
								<div class="mb-2">
									<input type="number" placeholder="직접입력...."
										class="form-control" id="example-flatpickr-time-standalone-24"
						...
						<div class="mb-4">
							...
							<table class="table table-striped table-vcenter">
								...
								<form action="" method="post">
									<tbody>
										<tr scope="row">
											<td class="fw-semibold fs-sm"><input type="checkbox">
											</th>
											<td class="fw-semibold fs-sm">전공/필수
											</th>
										...
										<tr scope="row">
											...
											<td class="fw-semibold fs-sm">014-124357 <input
							...
							<ul class="pagination justify-content-center">
								<li class="page-item"><a class="page-link"
									href="javascript:void(0)" tabindex="-1" aria-label="Previous">
								...
								<li class="page-item"><a class="page-link"
									href="javascript:void(0)" aria-label="Next"> <span
										aria-hidden="true"> <i class="fa fa-angle-double-right"></i>
